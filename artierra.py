...
cImPath = 'images/content/earth.jpg'
...
sImPath = 'images/style/patterns.jpg'
...
genImOutputPath = 'images/out.jpg'
...
cModel = VGG16(include_top=False, weights=None, input_tensor=cImArr)
sModel = VGG16(include_top=False, weights=None, input_tensor=sImArr)
gModel = VGG16(include_top=False, weights=None, input_tensor=gImPlaceholder)
